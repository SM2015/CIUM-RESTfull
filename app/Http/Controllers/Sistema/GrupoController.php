...
class GrupoController extends Controller {
	...
	public function index()
	{
		...
		{
			return Response::json(array("status"=>200,"messages"=>"ok","value"=>$grupo,"total"=>count($total)),200);
	...
	public function store(GrupoRequest $request)
	{
		...
		{
            DB::commit();
			return Response::json(array("status"=>201,"messages"=>"Creado","value"=>$grupo),201);
        } 
		else 
		{
            DB::rollback();
	...
	public function show($id)
	{
		...
		{
			return Response::json(array("status"=>200,"messages"=>"ok","value"=>$grupo),200);
		}
	}
